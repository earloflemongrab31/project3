...
<div class="container-600">
	...
	<div class="row">
		<div class="progressbar"><div class="inner"></div>
	</div>
	...
	<div class="page">
        ...
        <div class="row mt-50">
		  ...
		  <div class="row  mt-50">
			...
			<button type="button" class="btn btn-neutral prev">이전 단계</button>
			<button type="button" class="btn btn-positive next">다음 단계</button>
		</div>
     </div>
        ...
        <div class="container-600">
         ...
         <div class="row mt-50"> 
             <label>8. 고객님의 구매목적은 무엇입니까?</label>
    			<hr>
   			<textarea class = "input mt-10 w-100"  name="researchPurpose"></textarea>
     	</div>
     	
    	<div class="row mt-50"> 
    		<label>9. 쇼핑몰 이용시 불편사항을 적어주세요</label>
    			<hr>
    		<textarea class = "input mt-10 w-100"  name="researchComplain"></textarea>
     	</div>
    
   		 <div class="row mt-50"> 
			 <label>10. 온라인몰 관련 개선사항 등 여러 아이디어를 기술해주세요</label>
			    <hr>
    		<textarea class = "input mt-10 w-100"  name="researchIdea"></textarea>
          </div>

         <div class="row right mt-50">
			<button type="button" class="btn btn-neutral prev">이전 단계</button>
			<button type="button" class="btn btn-positive next">다음 단계</button>
			<button type="submit"  class="btn btn-positive">설문조사참여완료</button>
         </div>
	</div>
