...
<div class="row">
	...
	<div class="page">
        ...
        <div class="row float-container">
            <button class="prev btn btn-neutral btn-border float-left">이전</button>
            <button class="next btn btn-neutral btn-border float-right">다음</button>
        </div>
	...
	<div class="page">
		<div class="row">
    		...
    		<textarea class="input w-100 fix-size" name="researchPurpose"></textarea>
		</div>
        <div class="row float-container">
            <button class="prev btn btn-neutral btn-border float-left">이전</button>
            <button class="next btn btn-neutral btn-border float-right">다음</button>
